...
\begin{frame}{Otimização analítica}
  ...
  \end{block}
  \begin{block}{} [Duas] componentes: custo do desenvolvimento do
    [protótipo], que cresce com o aumento da exigência de perfeição
    deste, e o custo de sua aplicação, que diminui com a melhoria da
    correlação entre o modelo e o sistema físico real.
  \end{block}
\vfill
Fonte: BAZZO \& PEREIRA, 2006.
\end{frame}
...
\begin{frame}{Otimização analítica}
  \centering
  \includegraphics[width=1.1\textwidth]{otimizacao/2var}
